...
<html>
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="css/blogAnimate.css">
	<!-- Icomoon Icon Fonts-->
		...
		<div class="container">
			<div class="row">
				<div class="col-xs-2 text-left">
					<div id="gtco-logo"><a href="blog.jsp">Verb<span>.</span></a></div>
				</div>
	...
	<header id="gtco-header" class="gtco-cover" role="banner" style="background-image:url(img/blogImg/img_1.jpg);" data-stellar-background-ratio="0.5">
				...
				<div class="col-md-12">
					<ul id="gtco-post-list">
						<li class="full entry animate-box" data-animate-effect="fadeIn"> 
							<a href="single.jsp">
								<div class="entry-img" style="background-image: url(img/blogImg/img_1.jpg"></div>
						...
						<li class="two-third entry animate-box" data-animate-effect="fadeIn"> 
							<a href="single.jsp">
								<div class="entry-img" style="background-image: url(img/blogImg/img_2.jpg"></div>
								<div class="entry-desc">
									<h3>How Web Hosting Can Impact Page Load Speed</h3>
							...
							<a href="single.jsp" class="post-meta">Business  <span class="date-posted">4 days ago</span></a>
						</li>
						<li class="one-third entry animate-box" data-animate-effect="fadeIn">
							<a href="single.jsp">
								<div class="entry-img" style="background-image: url(img/blogImg/img_3.jpg"></div>
								<div class="entry-desc">
									<h3>How Web Hosting Can Impact Page Load Speed</h3>
						...
						<li class="one-third entry animate-box" data-animate-effect="fadeIn">
							<a href="single.jsp">
								<div class="entry-img" style="background-image: url(img/blogImg/img_4.jpg"></div>
								<div class="entry-desc">
									<h3>How Web Hosting Can Impact Page Load Speed</h3>
									<p>She packed her seven versalia, put her initial into the belt and made herself on the way.</p>
								</div>
						...
						<li class="one-third entry animate-box" data-animate-effect="fadeIn">
							<a href="single.jsp">
								<div class="entry-img" style="background-image: url(img/blogImg/img_5.jpg"></div>
								<div class="entry-desc">
									<h3>How Web Hosting Can Impact Page Load Speed</h3>
									<p>She packed her seven versalia, put her initial into the belt and made herself on the way.</p>
								</div>
						...
						<li class="one-third entry animate-box" data-animate-effect="fadeIn">
							<a href="single.jsp">
								<div class="entry-img" style="background-image: url(img/blogImg/img_6.jpg"></div>
								<div class="entry-desc">
									<h3>How Web Hosting Can Impact Page Load Speed</h3>
									<p>She packed her seven versalia, put her initial into the belt and made herself on the way.</p>
								</div>
						...
						<li class="one-half entry animate-box" data-animate-effect="fadeIn">
							<a href="single.jsp">
								<div class="entry-img" style="background-image: url(img/blogImg/img_7.jpg"></div>
								<div class="entry-desc">
									<h3>How Web Hosting Can Impact Page Load Speed</h3>
									<p>She packed her seven versalia, put her initial into the belt and made herself on the way. When she reached the first hills of the Italic Mountains.</p>
								</div>
						...
						<li class="one-half entry animate-box" data-animate-effect="fadeIn">
							<a href="single.jsp">
								<div class="entry-img" style="background-image: url(img/blogImg/img_8.jpg"></div>
								<div class="entry-desc">
									<h3>How Web Hosting Can Impact Page Load Speed</h3>
									<p>She packed her seven versalia, put her initial into the belt and made herself on the way. When she reached the first hills of the Italic Mountains.</p>
								</div>
						...
						<li class="one-third entry animate-box" data-animate-effect="fadeIn"> 
							<a href="single.jsp">
								<div class="entry-img" style="background-image: url(img/blogImg/img_9.jpg"></div>
								<div class="entry-desc">
									<h3>How Web Hosting Can Impact Page Load Speed</h3>
									<p>She packed her seven versalia, put her initial into the belt and made herself on the way. When she reached the first hills of the Italic Mountains.</p>
								</div>
						...
						<li class="two-third entry animate-box" data-animate-effect="fadeIn">
							<a href="single.jsp">
								<div class="entry-img" style="background-image: url(img/blogImg/img_10.jpg"></div>
								<div class="entry-desc">
									<h3>How Web Hosting Can Impact Page Load Speed</h3>
									<p>She packed her seven versalia, put her initial into the belt and made herself on the way. When she reached the first hills of the Italic Mountains.</p>
								</div>
			...
			<div class="row row-pb-md">
				...
				<div class="col-md-4">
					<div class="post-entry">
						<div class="post-img">
							<a href="#"><img src="img/blogImg/img_1.jpg" class="img-responsive" alt="Free HTML5 Bootstrap Template by GetTemplates.co"></a>
						</div>
						<div class="post-copy">
				...
				<div class="col-md-4">
					<div class="post-entry">
						<div class="post-img">
							<a href="#"><img src="img/blogImg/img_2.jpg" class="img-responsive" alt="Free HTML5 Bootstrap Template by GetTemplates.co"></a>
						</div>
						<div class="post-copy">
							<h4><a href="#">How Web Hosting Can Impact Page Load Speed</a></h4>
							<a href="#" class="post-meta"><span class="date-posted">4 days ago</span></a>
				...
				<div class="col-md-4">
					<div class="post-entry">
						<div class="post-img">
							<a href="#"><img src="img/blogImg/img_3.jpg" class="img-responsive" alt="Free HTML5 Bootstrap Template by GetTemplates.co"></a>
						</div>
						<div class="post-copy">
							<h4><a href="#">How Web Hosting Can Impact Page Load Speed</a></h4>
							<a href="#" class="post-meta"><span class="date-posted">4 days ago</span></a>
